...
def run():
    ...
    for i in range(len(transformation_data)):
        ...
        #print 'MTRIX1   {0:2} {1:9} {2:9}  {3:9}        {4:8}     1'.format(i+1,d11,d12,d13,datax[i])
        print 'MTRIX1  %2i % 1.6f % 1.6f % 1.6f       % 1.5f ' % (i+1,d11,d12,d13,x)
        print 'MTRIX2  %2i % 1.6f % 1.6f % 1.6f       % 1.5f ' % (i+1,d21,d22,d23,y)
        print 'MTRIX3  %2i % 1.6f % 1.6f % 1.6f       % 1.5f ' % (i+1,d31,d32,d33,z)
