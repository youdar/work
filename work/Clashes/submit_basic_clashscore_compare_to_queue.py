...
def run():
  ...
  where_to_run_dir = "/net/cci/youval/Work/work/Clashes/queue_clash_compare"
  commands = []
  cntr = 0
  # Set command path
  com_path = '/net/cci-filer2/raid1/home/youval/Work/work/Clashes/Test_internal_clashscore.py'
  #
  ...
  easy_qsub.run(
    ...
    size_of_chunks= 100) # because jobs are quick
