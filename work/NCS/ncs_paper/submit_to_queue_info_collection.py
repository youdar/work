...
class run_queue_tests(object):
  ...
  def __init__(self):
    ...
    cmd_path = '/NCS/ncs_paper/update_files_data_with_refinement_results.py'
    self.com_path = sources + cmd_path
    # where all queue output will be deposited
    self.where_to_run_dir = sources + '/NCS/ncs_paper/ncs_queue_results3'
  ...
  def get_commands(self):
    ...
    for pdb_id in self.pdb_log_id_list:
      outString = '{} {}'.format(self.com_path,pdb_id)
