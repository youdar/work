...
class manager(object):
  ...
  def reset_internals(self):
    ...
    self._clashscore_all_clashes = None
    self._clashscore_only_sym_op = None
    self._clashscore_without_sym_op = None
    self._clash_proxies_all_clashes = None
    self._clash_proxies_only_sym_op = None
    self._clash_proxies_without_sym_op = None
