...
def find_ncs_in_hierarchy(ph,
  ...
  Args:
    ...
    exclude_chains (set of str): set of chain IDs to exclude
  ...
  chains_info = get_chains_info(ph,exclude_chains=exclude_chains)
...
def get_chains_info(ph,selection_list=None,exclude_water=True,
  ...
  if not exclude_chains: exclude_chains = set()
  #
  chains_info =  {}
  if use_chains:
    model  = ph.models()[0]
    ...
    for ch in model.chains():
      if ch.id in exclude_chains: continue
